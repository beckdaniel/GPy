...
#Kernel
periodic7 = GPy.kern.periodic_exponential(1,lengthscale=700.,period=180.,n_freq=10,upper=1800.)
rbf7 = GPy.kern.rbf(1,lengthscale=30.)
rbf7_2 = GPy.kern.rbf(1,lengthscale=360.)
rbf7_3 = GPy.kern.rbf(1,lengthscale=1.)
base7_1 = rbf7  #periodic7 
base_white7 = GPy.kern.white(1)
Dw = 2
kernel7_1 = GPy.kern.icm(base7_1,R,index=0,Dw=Dw)
...
for district in districts[:1]:
    ...
    rbfi = GPy.kern.rbf(1)
    rbf1_1 = GPy.kern.rbf(1,lengthscale=30)
    rbf1_2 = GPy.kern.rbf(1,lengthscale=360)
    rbf1_3 = GPy.kern.rbf(1,lengthscale=1)
